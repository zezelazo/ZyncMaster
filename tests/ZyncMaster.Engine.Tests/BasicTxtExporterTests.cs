...
public sealed class BasicTxtExporterTests
{
    ...
    public async Task ExportAsync_NullOutputPath_Throws()
    {
        ...
        Func<Task> act = () => exporter.ExportAsync(2025, 5, null, null!, CancellationToken.None);
    ...
    public async Task ExportAsync_DrivesRunnerInSimpleModeWithMonthAndOutputPath()
    {
        ...
        await exporter.ExportAsync(2025, 5, calendars, @"C:\out\may.txt", CancellationToken.None);
    ...
    public async Task ExportAsync_NullCalendars_PassesNullThrough()
    {
        ...
        await exporter.ExportAsync(2024, 12, null, @"C:\out\dec.txt", CancellationToken.None);
