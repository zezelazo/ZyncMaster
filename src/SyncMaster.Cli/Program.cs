...
using SyncMaster.Cli;
using SyncMaster.Core;
using SyncMaster.Engine;

Console.OutputEncoding = Encoding.UTF8;
Console.WriteLine("=== SyncMaster Sync Host ===");
Console.WriteLine();
...
for (var i = 0; i < args.Length; i++)
{
    ...
    switch (arg)
    {
        ...
        default:
            ...
            Console.Error.WriteLine("Usage: SyncMaster.Cli [--pair | --once] [--interval <minutes>] [--server <url>]");
            Environment.Exit(1);
            return;
    }
}
