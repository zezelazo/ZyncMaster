...
// Entry point. A single-instance Mutex guard ensures only one tray-resident ZyncMaster
// runs per user session; a second launch exits immediately rather than stacking a
// second tray icon.
internal static class Program
{
    private const string SingleInstanceMutexName = "Global\\ZyncMaster.App.SingleInstance";
